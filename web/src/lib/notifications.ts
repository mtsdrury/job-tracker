...
// Client-safe utility functions (getTimeAgoString, getNotificationIcon, getNotificationVariant)
// are in notification-utils.ts to avoid pulling Prisma into client bundles.
